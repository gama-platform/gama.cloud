...
public class IDEWorkbenchMessages {
	...
	public static final String CloseResourceAction_problemMessage = "CloseResourceAction_problemMessage";
	public static final String CloseResourceAction_title = "CloseResourceAction_title";
	public static final String CloseResourceAction_warningForOne = "CloseResourceAction_warningForOne";
	...
	public static final String RefreshAction_progressMessage = "RefreshAction_progressMessage";
	public static final String RefreshAction_problemMessage = "RefreshAction_problemMessage";
	public static final String RefreshAction_problemTitle = "RefreshAction_problemTitle";
	public static final String RenameResourceAction_checkTitle = "RenameResourceAction_checkTitle";
	public static final String RenameResourceAction_readOnlyCheck = "RenameResourceAction_readOnlyCheck";
	public static final String RenameResourceAction_resourceExists = "RenameResourceAction_resourceExists";
	...
	public static final String RenameResourceAction_problemTitle = "RenameResourceAction_problemTitle";
	public static final String RenameResourceAction_nameMustBeDifferent = "RenameResourceAction_nameMustBeDifferent";
	public static final String RenameResourceAction_nameExists = "RenameResourceAction_nameExists";
	public static final String RenameResourceAction_inputDialogTitle = "RenameResourceAction_inputDialogTitle";
	public static final String RenameResourceAction_inputDialogMessage = "RenameResourceAction_inputDialogMessage";
	public static final String RenameResourceAction_operationTitle = "RenameResourceAction_operationTitle";
