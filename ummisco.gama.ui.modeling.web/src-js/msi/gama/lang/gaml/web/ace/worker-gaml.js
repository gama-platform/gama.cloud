...
define('ace/mode/gaml_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/gaml/gamlparse'], function(require, exports, module) {

	var oop = require("../lib/oop");
	var Mirror = require("../worker/mirror").Mirror;
	var gamlparse = require("../mode/gaml/gamlparse");
	
	importScripts("../parser/antlr-all-min.js");
	importScripts("../parser/GamlLexer.js");
	importScripts("../parser/GamlParser.js");
	...
	(function() {
	    ...
	    this.onUpdate = function() {
		    ...
		    lexer = new GamlLexer(cstream);
		    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
		    parser = new GamlParser(tstream);
		    try {
		    	parser.entryRuleEntry();
		    } catch(err) {
...
define('ace/mode/gaml/gamlparse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'gamlparse', function (exports) {
