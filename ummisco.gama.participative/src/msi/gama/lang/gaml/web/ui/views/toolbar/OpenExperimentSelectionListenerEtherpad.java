 ...
 *
 */
public class OpenExperimentSelectionListenerEtherpad implements Selector {
	 ...
	 * 
	 */
	public OpenExperimentSelectionListenerEtherpad(final EtherpadEditor editor, final GamlEditorState state,
			final IModelRunner runner) {
		this.editor = editor;
		this.state = state;
		this.runner = runner;
