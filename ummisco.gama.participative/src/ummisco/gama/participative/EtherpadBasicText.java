...
public class EtherpadBasicText extends BasicText {
	...
	static final Logger logger = Logger.getLogger(EtherpadBasicText.class);
	
	private static final String REMOTE_TYPE = "ummisco.gama.participative.EhterpadBasicText";
	...
	private final EtherpadBasicTextOperationHandler operationHandler = new EtherpadBasicTextOperationHandler(this);
	private RemoteObject remoteObject;
	private List<IPath> resources = new ArrayList<IPath>();
	private String url = "";
	private String status = "";
	private ITextSelection selection =  (ITextSelection) TextSelection.emptySelection();
	...
	protected void handleTextSelected(Event event) {
		...
		this.selection = (ITextSelection) new TextSelection(startOffset, length);
	}
...
//		properties.add("columnEnd", range.columnEnd);
	...
	public ITextSelection getSelection() {
		...
		if (selection!=null)
			return selection;
		return (ITextSelection) TextSelection.emptySelection();
	}
