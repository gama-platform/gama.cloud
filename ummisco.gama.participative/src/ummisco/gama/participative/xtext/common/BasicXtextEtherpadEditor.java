 ...
 */
public class BasicXtextEtherpadEditor extends EtherpadBasicTextEditor implements IBasicXtextEditor {
// ici to delete protected
	protected static final Logger logger = Logger.getLogger(BasicXtextEtherpadEditor.class);
