...
public class EtherpadBasicTextEditor extends EditorPart implements ISaveablesSource, IBasicTextEditor {
	...
	static final Logger logger = Logger.getLogger(EtherpadBasicTextEditor.class);
	...
	public IAction getAction(String actionId) {
		...
		if (actionBarContributor instanceof BasicTextEtherpadEditorContributor) {
		    return ((BasicTextEtherpadEditorContributor)actionBarContributor).getAction(this, actionId);
		}
		return null;
	}
