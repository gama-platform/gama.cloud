...
public class GL2 extends GL2ES2 {
	...
	/**
	 * <code>GL_VERSION_1_5</code>, <code>GL_ARB_vertex_buffer_object</code><br>
	 * Alias for: <code>GL_FOG_COORDINATE_ARRAY_BUFFER_BINDING_ARB</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_INTENSITY8UI_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_0</code>, <code>GL_OES_texture_cube_map</code><br>
	 * Alias for: <code>GL_TEXTURE_GEN_MODE_OES</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_EXT_texture_env_combine</code>,
	 * <code>GL_ARB_texture_env_combine</code><br>
	 * Alias for: <code>GL_SOURCE0_RGB_EXT</code>,
	 * <code>GL_SOURCE0_RGB_ARB</code> - CType: int
	 */
	public static final int GL_SOURCE0_RGB = 0x8580;
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE_ALPHA8I_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_POST_COLOR_MATRIX_RED_SCALE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_vertex_program</code>, <code>GL_ARB_fragment_program</code>
	 * - CType: int
	 */
	public static final int GL_PROGRAM_ERROR_STRING_ARB = 0x8874;
	/**
	 * <code>GL_NV_gpu_shader5</code>, <code>GL_AMD_gpu_shader_int64</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_ALPHA8UI_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_2_1</code>, <code>GL_NV_sRGB_formats</code>,
	 * <code>GL_EXT_texture_sRGB</code><br>
	 * Alias for: <code>GL_SLUMINANCE8_NV</code>,
	 * <code>GL_SLUMINANCE8_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_APPLE_flush_buffer_range</code><br>
	 * Alias for: <code>GL_BUFFER_SERIALIZED_MODIFY_APPLE</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_vertex_array</code><br>
	 * Alias for: <code>GL_EDGE_FLAG_ARRAY_STRIDE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_ALPHA_SIZE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_ALPHA32UI_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_5</code>, <code>GL_ARB_vertex_buffer_object</code><br>
	 * Alias for: <code>GL_EDGE_FLAG_ARRAY_BUFFER_BINDING_ARB</code> - CType:
	 * int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_secondary_color</code><br>
	 * Alias for: <code>GL_SECONDARY_COLOR_ARRAY_SIZE_EXT</code> - CType: int
	 */
	public static final int GL_SECONDARY_COLOR_ARRAY_SIZE = 0x845a;
	/** <code>GL_NV_texture_shader</code> - CType: int */
	public static final int GL_SIGNED_RGBA8_NV = 0x86fc;
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_fog_coord</code><br>
	 * Alias for: <code>GL_FOG_COORDINATE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_secondary_color</code>,
	 * <code>GL_ARB_vertex_program</code><br>
	 * Alias for: <code>GL_COLOR_SUM_EXT</code>, <code>GL_COLOR_SUM_ARB</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_fog_coord</code><br>
	 * Alias for: <code>GL_FOG_COORDINATE_ARRAY_STRIDE_EXT</code> - CType: int
	 */
	public static final int GL_FOG_COORDINATE_ARRAY_STRIDE = 0x8455;
	/** <code>GL_NV_texture_shader</code> - CType: int */
	public static final int GL_DOT_PRODUCT_NV = 0x86ec;
	/**
	 * <code>GL_VERSION_1_0</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_TEXTURE_INTENSITY_SIZE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE_ALPHA32I_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_ALPHA32I_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE8UI_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ES_VERSION_3_2</code>,
	 * <code>GL_KHR_blend_equation_advanced</code>,
	 * <code>GL_NV_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_SOFTLIGHT_KHR</code>, <code>GL_SOFTLIGHT_NV</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_CONVOLUTION_FORMAT_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_NV_sRGB_formats</code>, <code>GL_EXT_texture_sRGB</code><br>
	 * Alias for: <code>GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_NV</code>,
	 * <code>GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_SGI</code> - CType: int
	 */
	 ...
	 * <code>GL_VERSION_2_1</code>, <code>GL_NV_sRGB_formats</code>,
	 * <code>GL_EXT_texture_sRGB</code><br>
	 * Alias for: <code>GL_SLUMINANCE8_ALPHA8_NV</code>,
	 * <code>GL_SLUMINANCE8_ALPHA8_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_2_0</code>, <code>GL_ARB_fragment_program</code>,
	 * <code>GL_NV_fragment_program</code><br>
	 * Alias for: <code>GL_MAX_TEXTURE_COORDS_ARB</code>,
	 * <code>GL_MAX_TEXTURE_COORDS_NV</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_vertex_array</code><br>
	 * Alias for: <code>GL_INDEX_ARRAY_STRIDE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_NV_geometry_program4</code>,
	 * <code>GL_EXT_geometry_shader4</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_2_1</code>, <code>GL_EXT_texture_sRGB</code>,
	 * <code>GL_NV_sRGB_formats</code><br>
	 * Alias for: <code>GL_SLUMINANCE_ALPHA_EXT</code>,
	 * <code>GL_SLUMINANCE_ALPHA_NV</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_RGBA_INTEGER_MODE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_ARB_texture_compression</code><br>
	 * Alias for: <code>GL_COMPRESSED_INTENSITY_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_INTENSITY16_EXT</code> - CType: int
	 */
	public static final int GL_INTENSITY16 = 0x804d;
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_INTENSITY12_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_REDUCE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_fog_coord</code><br>
	 * Alias for: <code>GL_FRAGMENT_DEPTH_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_disjoint_timer_query</code>, <code>GL_EXT_timer_query</code>
	 * - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_2_1</code>, <code>GL_EXT_texture_sRGB</code><br>
	 * Alias for: <code>GL_COMPRESSED_SLUMINANCE_EXT</code> - CType: int
	 */
	public static final int GL_COMPRESSED_SLUMINANCE = 0x8c4a;
	/**
	 * <code>GL_VERSION_2_1</code>, <code>GL_EXT_texture_sRGB</code><br>
	 * Alias for: <code>GL_COMPRESSED_SLUMINANCE_ALPHA_EXT</code> - CType: int
	 */
	public static final int GL_COMPRESSED_SLUMINANCE_ALPHA = 0x8c4b;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_HISTOGRAM_ALPHA_SIZE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_POST_COLOR_MATRIX_RED_BIAS_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_LUMINANCE6_ALPHA2_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ES_VERSION_3_2</code>,
	 * <code>GL_NV_blend_equation_advanced</code>,
	 * <code>GL_KHR_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_MULTIPLY_NV</code>, <code>GL_MULTIPLY_KHR</code> -
	 * CType: int
	 */
	public static final int GL_MULTIPLY = 0x9294;
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_ARB_transpose_matrix</code><br>
	 * Alias for: <code>GL_TRANSPOSE_MODELVIEW_MATRIX_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE32UI_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_2</code>,
	 * <code>GL_EXT_separate_specular_color</code><br>
	 * Alias for: <code>GL_SINGLE_COLOR_EXT</code> - CType: int
	 */
	public static final int GL_SINGLE_COLOR = 0x81f9;
	/**
	 * <code>GL_VERSION_3_0</code>, <code>GL_ARB_color_buffer_float</code><br>
	 * Alias for: <code>GL_CLAMP_FRAGMENT_COLOR_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_POST_COLOR_MATRIX_ALPHA_BIAS_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_3_0</code>, <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_ALPHA_INTEGER_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_0</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_TEXTURE_LUMINANCE_SIZE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>,
	 * <code>GL_HP_convolution_border_modes</code><br>
	 * Alias for: <code>GL_REPLICATE_BORDER_HP</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_INTENSITY32I_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_framebuffer_object</code>, <code>GL_VERSION_3_0</code>,
	 * <code>GL_ARB_texture_float</code><br>
	 * Alias for: <code>GL_TEXTURE_LUMINANCE_TYPE_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_NV_sRGB_formats</code>, <code>GL_EXT_texture_sRGB</code><br>
	 * Alias for: <code>GL_COMPRESSED_SRGB_S3TC_DXT1_NV</code>,
	 * <code>GL_COMPRESSED_SRGB_S3TC_DXT1_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_NV_blend_equation_advanced</code>,
	 * <code>GL_KHR_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_DIFFERENCE_NV</code>, <code>GL_DIFFERENCE_KHR</code>
	 * - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_ALPHA16_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_ALPHA12_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_LUMINANCE16_ALPHA16_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_CONVOLUTION_WIDTH_EXT</code> - CType: int
	 */
	public static final int GL_CONVOLUTION_WIDTH = 0x8018;
	/** <code>GL_NV_command_list</code> - CType: int */
	public static final int GL_ELEMENT_ADDRESS_COMMAND_NV = 0x8;
	/**
	 * <code>GL_APPLE_ycbcr_422</code>, <code>GL_APPLE_rgb_422</code> - CType:
	 * int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_POST_CONVOLUTION_BLUE_SCALE_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_KHR_blend_equation_advanced</code>,
	 * <code>GL_NV_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_DARKEN_KHR</code>, <code>GL_DARKEN_NV</code> - CType:
	 * int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE_INTEGER_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_CONVOLUTION_FILTER_SCALE_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_VERSION_1_3</code>, <code>GL_EXT_texture_env_combine</code>,
	 * <code>GL_ARB_texture_env_combine</code><br>
	 * Alias for: <code>GL_SOURCE1_RGB_EXT</code>,
	 * <code>GL_SOURCE1_RGB_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_texture_float</code><br>
	 * Alias for: <code>GL_INTENSITY16F_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_APPLE_texture_range</code>,
	 * <code>GL_APPLE_vertex_array_range</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_ARB_texture_compression</code><br>
	 * Alias for: <code>GL_COMPRESSED_ALPHA_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_fog_coord</code><br>
	 * Alias for: <code>GL_FOG_COORDINATE_ARRAY_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_MINMAX_FORMAT_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_CONVOLUTION_1D_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_NV_framebuffer_mixed_samples</code>,
	 * <code>GL_NV_multisample_coverage</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_RED_SIZE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_COLOR_MATRIX_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_fog_coord</code><br>
	 * Alias for: <code>GL_FOG_COORDINATE_ARRAY_POINTER_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE_ALPHA_INTEGER_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE_ALPHA32UI_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_NV_blend_equation_advanced</code>,
	 * <code>GL_KHR_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_HSL_COLOR_NV</code>, <code>GL_HSL_COLOR_KHR</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_0</code>, <code>GL_NV_path_rendering</code><br>
	 * Alias for: <code>GL_OBJECT_LINEAR_NV</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_CONVOLUTION_2D_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE_ALPHA16UI_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_PROXY_POST_CONVOLUTION_COLOR_TABLE_SGI</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE32I_EXT</code> - CType: int
	 */
	public static final int GL_LUMINANCE32I = 0x8d86;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_HISTOGRAM_FORMAT_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_LUMINANCE4_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_5</code>, <code>GL_ARB_vertex_buffer_object</code><br>
	 * Alias for: <code>GL_SECONDARY_COLOR_ARRAY_BUFFER_BINDING_ARB</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_snorm</code>, <code>GL_VERSION_3_1</code> - CType:
	 * int
	 */
	 ...
	 * <code>GL_ARB_imaging</code>,
	 * <code>GL_HP_convolution_border_modes</code><br>
	 * Alias for: <code>GL_CONSTANT_BORDER_HP</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_MINMAX_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_INTENSITY32UI_EXT</code> - CType: int
	 */
	public static final int GL_INTENSITY32UI = 0x8d73;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_PROXY_POST_COLOR_MATRIX_COLOR_TABLE_SGI</code> -
	 * CType: int
	 */
	 ...
	 * <code>GL_NV_blend_equation_advanced</code>,
	 * <code>GL_KHR_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_COLORDODGE_NV</code>, <code>GL_COLORDODGE_KHR</code>
	 * - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_POST_CONVOLUTION_GREEN_BIAS_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_2_0</code>, <code>GL_NV_vertex_program</code>,
	 * <code>GL_ARB_vertex_program</code><br>
	 * Alias for: <code>GL_VERTEX_PROGRAM_TWO_SIDE_NV</code>,
	 * <code>GL_VERTEX_PROGRAM_TWO_SIDE_ARB</code> - CType: int
	 */
	 ...
	 * <code>GL_VERSION_2_1</code>, <code>GL_EXT_texture_sRGB</code>,
	 * <code>GL_NV_sRGB_formats</code><br>
	 * Alias for: <code>GL_SLUMINANCE_EXT</code>, <code>GL_SLUMINANCE_NV</code>
	 * - CType: int
	 */
	public static final int GL_SLUMINANCE = 0x8c46;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_MAX_CONVOLUTION_HEIGHT_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_HISTOGRAM_WIDTH_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_AMD_sparse_texture</code>, <code>GL_ARB_sparse_texture</code>,
	 * <code>GL_EXT_sparse_texture</code><br>
	 * Alias for: <code>GL_MAX_SPARSE_ARRAY_TEXTURE_LAYERS_ARB</code>,
	 * <code>GL_MAX_SPARSE_ARRAY_TEXTURE_LAYERS_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_NV_blend_equation_advanced</code>,
	 * <code>GL_KHR_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_HSL_HUE_NV</code>, <code>GL_HSL_HUE_KHR</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_texture_lod_bias</code><br>
	 * Alias for: <code>GL_TEXTURE_FILTER_CONTROL_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_ALPHA4_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_vertex_array</code><br>
	 * Alias for: <code>GL_EDGE_FLAG_ARRAY_POINTER_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_texture_buffer_object</code>,
	 * <code>GL_EXT_texture_buffer_object</code><br>
	 * Alias for: <code>GL_TEXTURE_BUFFER_FORMAT_ARB</code>,
	 * <code>GL_TEXTURE_BUFFER_FORMAT_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_VERSION_1_3</code>, <code>GL_EXT_texture_env_combine</code>,
	 * <code>GL_ARB_texture_env_combine</code><br>
	 * Alias for: <code>GL_SOURCE0_ALPHA_EXT</code>,
	 * <code>GL_SOURCE0_ALPHA_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_ARB_texture_env_combine</code>,
	 * <code>GL_EXT_texture_env_combine</code><br>
	 * Alias for: <code>GL_SOURCE2_ALPHA_ARB</code>,
	 * <code>GL_SOURCE2_ALPHA_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_BIAS_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_ARB_transpose_matrix</code><br>
	 * Alias for: <code>GL_TRANSPOSE_COLOR_MATRIX_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_ARB_texture_compression</code><br>
	 * Alias for: <code>GL_COMPRESSED_LUMINANCE_ARB</code> - CType: int
	 */
	public static final int GL_COMPRESSED_LUMINANCE = 0x84ea;
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_fog_coord</code><br>
	 * Alias for: <code>GL_CURRENT_FOG_COORDINATE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_vertex_array</code><br>
	 * Alias for: <code>GL_EDGE_FLAG_ARRAY_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_APPLE_flush_buffer_range</code><br>
	 * Alias for: <code>GL_BUFFER_FLUSHING_UNMAP_APPLE</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_vertex_array</code><br>
	 * Alias for: <code>GL_INDEX_ARRAY_TYPE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_POST_COLOR_MATRIX_GREEN_SCALE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_ARB_shadow</code><br>
	 * Alias for: <code>GL_COMPARE_R_TO_TEXTURE_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_HISTOGRAM_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_INTENSITY_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_POST_COLOR_MATRIX_GREEN_BIAS_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_ARB_transpose_matrix</code><br>
	 * Alias for: <code>GL_TRANSPOSE_TEXTURE_MATRIX_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_vertex_array</code><br>
	 * Alias for: <code>GL_INDEX_ARRAY_EXT</code> - CType: int
	 */
	public static final int GL_INDEX_ARRAY = 0x8077;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_POST_CONVOLUTION_ALPHA_SCALE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_sRGB</code>, <code>GL_NV_sRGB_formats</code><br>
	 * Alias for: <code>GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT</code>,
	 * <code>GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_NV</code> - CType: int
	 */
	 ...
	 * <code>GL_KHR_blend_equation_advanced</code>,
	 * <code>GL_NV_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_HSL_SATURATION_KHR</code>,
	 * <code>GL_HSL_SATURATION_NV</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE_ALPHA16I_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_INTENSITY8_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_INTENSITY4_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_secondary_color</code><br>
	 * Alias for: <code>GL_SECONDARY_COLOR_ARRAY_TYPE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_PROXY_COLOR_TABLE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_5</code>, <code>GL_ARB_vertex_buffer_object</code><br>
	 * Alias for: <code>GL_INDEX_ARRAY_BUFFER_BINDING_ARB</code> - CType: int
	 */
	 ...
	 * <code>GL_NV_blend_equation_advanced</code>,
	 * <code>GL_KHR_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_COLORBURN_NV</code>, <code>GL_COLORBURN_KHR</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_secondary_color</code><br>
	 * Alias for: <code>GL_SECONDARY_COLOR_ARRAY_POINTER_EXT</code> - CType: int
	 */
	public static final int GL_SECONDARY_COLOR_ARRAY_POINTER = 0x845d;
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_LUMINANCE12_ALPHA12_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_0</code>, <code>GL_NV_path_rendering</code><br>
	 * Alias for: <code>GL_EYE_LINEAR_NV</code> - CType: int
	 */
	public static final int GL_EYE_LINEAR = 0x2400;
	/**
	 * <code>GL_EXT_texture_sRGB</code>, <code>GL_NV_sRGB_formats</code><br>
	 * Alias for: <code>GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT</code>,
	 * <code>GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_NV</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_POST_COLOR_MATRIX_ALPHA_SCALE_SGI</code> - CType: int
	 */
	public static final int GL_POST_COLOR_MATRIX_ALPHA_SCALE = 0x80b7;
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_ARB_transpose_matrix</code><br>
	 * Alias for: <code>GL_TRANSPOSE_PROJECTION_MATRIX_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_ALPHA16UI_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_0</code>, <code>GL_NV_path_rendering</code><br>
	 * Alias for: <code>GL_3_BYTES_NV</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_POST_CONVOLUTION_GREEN_SCALE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_INTENSITY_SIZE_SGI</code> - CType: int
	 */
	public static final int GL_COLOR_TABLE_INTENSITY_SIZE = 0x80df;
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_ALPHA16I_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_ARB_framebuffer_object</code>, <code>GL_VERSION_3_0</code>,
	 * <code>GL_ARB_texture_float</code><br>
	 * Alias for: <code>GL_TEXTURE_INTENSITY_TYPE_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_array</code><br>
	 * Alias for: <code>GL_COMPARE_REF_DEPTH_TO_TEXTURE_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_NV_blend_equation_advanced</code>,
	 * <code>GL_KHR_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_HARDLIGHT_NV</code>, <code>GL_HARDLIGHT_KHR</code> -
	 * CType: int
	 */
	public static final int GL_HARDLIGHT = 0x929b;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_COLOR_MATRIX_STACK_DEPTH_SGI</code> - CType: int
	 */
	public static final int GL_COLOR_MATRIX_STACK_DEPTH = 0x80b2;
	/**
	 * <code>GL_VERSION_3_0</code>, <code>GL_ARB_color_buffer_float</code><br>
	 * Alias for: <code>GL_CLAMP_VERTEX_COLOR_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_secondary_color</code><br>
	 * Alias for: <code>GL_CURRENT_SECONDARY_COLOR_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_5</code>, <code>GL_ARB_vertex_buffer_object</code>,
	 * <code>GL_OES_matrix_palette</code><br>
	 * Alias for: <code>GL_WEIGHT_ARRAY_BUFFER_BINDING_ARB</code>,
	 * <code>GL_WEIGHT_ARRAY_BUFFER_BINDING_OES</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_POST_CONVOLUTION_RED_SCALE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_packed_float</code><br>
	 * Alias for: <code>GL_RGBA_SIGNED_COMPONENTS_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_0</code>, <code>GL_NV_path_rendering</code><br>
	 * Alias for: <code>GL_2_BYTES_NV</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_CONVOLUTION_HEIGHT_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE16I_EXT</code> - CType: int
	 */
	public static final int GL_LUMINANCE16I = 0x8d8c;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_MINMAX_SINK_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_KHR_blend_equation_advanced</code>,
	 * <code>GL_NV_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_LIGHTEN_KHR</code>, <code>GL_LIGHTEN_NV</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_BLUE_SIZE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_INTENSITY16UI_EXT</code> - CType: int
	 */
	public static final int GL_INTENSITY16UI = 0x8d79;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_MAX_CONVOLUTION_WIDTH_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_vertex_array</code><br>
	 * Alias for: <code>GL_INDEX_ARRAY_POINTER_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_ARB_depth_texture</code><br>
	 * Alias for: <code>GL_DEPTH_TEXTURE_MODE_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture_object</code><br>
	 * Alias for: <code>GL_TEXTURE_RESIDENT_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_MAX_COLOR_MATRIX_STACK_DEPTH_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_HISTOGRAM_LUMINANCE_SIZE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_HISTOGRAM_SINK_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_POST_COLOR_MATRIX_BLUE_BIAS_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_matrix</code><br>
	 * Alias for: <code>GL_POST_COLOR_MATRIX_BLUE_SCALE_SGI</code> - CType: int
	 */
	public static final int GL_POST_COLOR_MATRIX_BLUE_SCALE = 0x80b6;
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE8I_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_FORMAT_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_LUMINANCE12_ALPHA4_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_LUMINANCE_SIZE_SGI</code> - CType: int
	 */
	 ...
	 * <code>GL_KHR_blend_equation_advanced</code>,
	 * <code>GL_NV_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_OVERLAY_KHR</code>, <code>GL_OVERLAY_NV</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_ARB_texture_float</code><br>
	 * Alias for: <code>GL_INTENSITY32F_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_POST_CONVOLUTION_COLOR_TABLE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_secondary_color</code><br>
	 * Alias for: <code>GL_SECONDARY_COLOR_ARRAY_STRIDE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_POST_CONVOLUTION_ALPHA_BIAS_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_KHR_blend_equation_advanced</code>,
	 * <code>GL_NV_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_HSL_LUMINOSITY_KHR</code>,
	 * <code>GL_HSL_LUMINOSITY_NV</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_fog_coord</code><br>
	 * Alias for: <code>GL_FOG_COORDINATE_SOURCE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture_object</code><br>
	 * Alias for: <code>GL_TEXTURE_PRIORITY_EXT</code> - CType: int
	 */
	public static final int GL_TEXTURE_PRIORITY = 0x8066;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_PROXY_HISTOGRAM_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_SCALE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_TABLE_TOO_LARGE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_3DFX_multisample</code>,
	 * <code>GL_ARB_multisample</code>, <code>GL_EXT_multisample</code><br>
	 * Alias for: <code>GL_MULTISAMPLE_BIT_3DFX</code>,
	 * <code>GL_MULTISAMPLE_BIT_ARB</code>, <code>GL_MULTISAMPLE_BIT_EXT</code>
	 * - CType: int
	 */
	public static final int GL_MULTISAMPLE_BIT = 0x20000000;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_SEPARABLE_2D_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_0</code>, <code>GL_NV_path_rendering</code><br>
	 * Alias for: <code>GL_4_BYTES_NV</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_POST_CONVOLUTION_RED_BIAS_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_VERSION_1_2</code>,
	 * <code>GL_EXT_separate_specular_color</code><br>
	 * Alias for: <code>GL_LIGHT_MODEL_COLOR_CONTROL_EXT</code> - CType: int
	 */
	public static final int GL_LIGHT_MODEL_COLOR_CONTROL = 0x81f8;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_POST_COLOR_MATRIX_COLOR_TABLE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_LUMINANCE16_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_POST_CONVOLUTION_BLUE_BIAS_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_OES_texture_cube_map</code>,
	 * <code>GL_NV_texgen_reflection</code>,
	 * <code>GL_ARB_texture_cube_map</code>,
	 * <code>GL_EXT_texture_cube_map</code><br>
	 * Alias for: <code>GL_NORMAL_MAP_OES</code>, <code>GL_NORMAL_MAP_NV</code>,
	 * <code>GL_NORMAL_MAP_ARB</code>, <code>GL_NORMAL_MAP_EXT</code> - CType:
	 * int
	 */
	...
	/**
	 * <code>GL_VERSION_1_1</code>, <code>GL_EXT_texture</code><br>
	 * Alias for: <code>GL_LUMINANCE12_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE_ALPHA8UI_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_VERSION_1_3</code>, <code>GL_EXT_texture_env_combine</code>,
	 * <code>GL_ARB_texture_env_combine</code><br>
	 * Alias for: <code>GL_SOURCE1_ALPHA_EXT</code>,
	 * <code>GL_SOURCE1_ALPHA_ARB</code> - CType: int
	 */
	 ...
	 * <code>GL_ARB_imaging</code>,
	 * <code>GL_HP_convolution_border_modes</code><br>
	 * Alias for: <code>GL_CONVOLUTION_BORDER_COLOR_HP</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_LUMINANCE16UI_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_secondary_color</code><br>
	 * Alias for: <code>GL_SECONDARY_COLOR_ARRAY_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_framebuffer_sRGB</code><br>
	 * Alias for: <code>GL_FRAMEBUFFER_SRGB_CAPABLE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_HISTOGRAM_RED_SIZE_EXT</code> - CType: int
	 */
	public static final int GL_HISTOGRAM_RED_SIZE = 0x8028;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_CONVOLUTION_BORDER_MODE_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_NV_blend_equation_advanced</code>,
	 * <code>GL_KHR_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_EXCLUSION_NV</code>, <code>GL_EXCLUSION_KHR</code> -
	 * CType: int
	 */
	...
	/**
	 * <code>GL_VERSION_1_3</code>, <code>GL_ARB_texture_compression</code><br>
	 * Alias for: <code>GL_COMPRESSED_LUMINANCE_ALPHA_ARB</code> - CType: int
	 */
	 ...
	 * <code>GL_VERSION_1_3</code>, <code>GL_OES_texture_cube_map</code>,
	 * <code>GL_ARB_texture_cube_map</code>,
	 * <code>GL_EXT_texture_cube_map</code>,
	 * <code>GL_NV_texgen_reflection</code><br>
	 * Alias for: <code>GL_REFLECTION_MAP_OES</code>,
	 * <code>GL_REFLECTION_MAP_ARB</code>, <code>GL_REFLECTION_MAP_EXT</code>,
	 * <code>GL_REFLECTION_MAP_NV</code> - CType: int
	 */
	 ...
	 * <code>GL_VERSION_1_2</code>,
	 * <code>GL_EXT_separate_specular_color</code><br>
	 * Alias for: <code>GL_SEPARATE_SPECULAR_COLOR_EXT</code> - CType: int
	 */
	public static final int GL_SEPARATE_SPECULAR_COLOR = 0x81fa;
	/**
	 * <code>GL_VERSION_1_4</code>, <code>GL_EXT_fog_coord</code><br>
	 * Alias for: <code>GL_FOG_COORDINATE_ARRAY_TYPE_EXT</code> - CType: int
	 */
	public static final int GL_FOG_COORDINATE_ARRAY_TYPE = 0x8454;
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_convolution</code><br>
	 * Alias for: <code>GL_CONVOLUTION_FILTER_BIAS_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_WIDTH_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_HISTOGRAM_BLUE_SIZE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_EXT_histogram</code><br>
	 * Alias for: <code>GL_HISTOGRAM_GREEN_SIZE_EXT</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_ALPHA8I_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_VERSION_1_3</code>, <code>GL_EXT_texture_env_combine</code>,
	 * <code>GL_ARB_texture_env_combine</code><br>
	 * Alias for: <code>GL_SOURCE2_RGB_EXT</code>,
	 * <code>GL_SOURCE2_RGB_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_OES_texture_3D</code>,
	 * <code>GL_EXT_framebuffer_object</code><br>
	 * Alias for: <code>GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_OES</code>,
	 * <code>GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_EXT</code> - CType:
	 * int
	 */
	...
	/**
	 * <code>GL_ATI_pixel_format_float</code>,
	 * <code>GL_ARB_color_buffer_float</code><br>
	 * Alias for: <code>GL_RGBA_FLOAT_MODE_ATI</code>,
	 * <code>GL_RGBA_FLOAT_MODE_ARB</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_INTENSITY16I_EXT</code> - CType: int
	 */
	 ...
	 * <code>GL_KHR_blend_equation_advanced</code>,
	 * <code>GL_NV_blend_equation_advanced</code><br>
	 * Alias for: <code>GL_SCREEN_KHR</code>, <code>GL_SCREEN_NV</code> - CType:
	 * int
	 */
	...
	/**
	 * <code>GL_ARB_imaging</code>, <code>GL_SGI_color_table</code><br>
	 * Alias for: <code>GL_COLOR_TABLE_GREEN_SIZE_SGI</code> - CType: int
	 */
	...
	/**
	 * <code>GL_EXT_texture_integer</code><br>
	 * Alias for: <code>GL_INTENSITY8I_EXT</code> - CType: int
	 */
	...
	public void glVertexAttribPointer(int attributePosition, int i, int glFloat, boolean b, int j,
	...
	public void glDrawElements(int glTriangles, int i, int glUnsignedShort, ShortBuffer indicesBuffer) {
		// TODO Auto-generated method stub
	...
	public void glUniform1i(int uniformTextureId, int textureId) {
		// TODO Auto-generated method stub

	}

	public int glGetAttribLocation(int program, String string) {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	public void glAttachShader(int id, int vertexShaderId) {
		// TODO Auto-generated method stub
	...
	public void glGetProgramiv(int id, int glLinkStatus, int[] status, int i) {
		// TODO Auto-generated method stub

	}

	public void glGetProgramInfoLog(int id, int i, int[] js, int j, byte[] chars, int k) {
		// TODO Auto-generated method stub
	...
	public void glShaderSource(int id, int i, String[] strings, int[] js, int j) {
		// TODO Auto-generated method stub
	...
	public void glGetShaderiv(int id, int glCompileStatus, int[] status, int i) {
		// TODO Auto-generated method stub
	...
	public void glGetDoublev(int glModelviewMatrix, double[] mvmatrix, int i) {
		// TODO Auto-generated method stub
	...
	public void glOrtho(double d, double e, double f, double maxDim, double g, double h) {
		// TODO Auto-generated method stub

	}

	public void glTranslated(double d, double e, double f) {
		// TODO Auto-generated method stub
...
//		obj.add("img",  Arrays.toString(barray));  
	...
	public void glDrawElements(int glTriangles, int i, int glUnsignedInt, int j) {
		String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();

		JsonObject obj = new JsonObject();
		obj.add("glTriangles", glTriangles);
		obj.add("i", i);
...
//		WebGLComposite.execJS("appendErr", obj);
	...
	public void glBufferSubData(int glArrayBuffer, int offset, int i, float[] data) {
		if((data==null )) return;
		String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();

		JsonObject obj = new JsonObject();
		obj.add("glArrayBuffer", glArrayBuffer);
	...
	public void glDetachShader(int programID, int fragmentShaderID) {
		// TODO Auto-generated method stub
	...
	public void glBlendColor(float f, float g, float h, float currentObjectAlpha) {
		// TODO Auto-generated method stub
		
	}

	public boolean glIsEnabled(int state) {
		// TODO Auto-generated method stub
		return false;
	}
