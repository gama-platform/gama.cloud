 ...
 *
 **********************************************************************************************/
package msi.gama.lang.gaml.web.ui.dialogs;
...
public abstract class AbstractDetailsDialog extends Dialog {
	...
	protected void createButtonsForButtonBar(final Composite parent) {
		...
		detailsButton =
			createButton(parent, IDialogConstants.DETAILS_ID, "showDetails",
				false);
	}
	...
	protected void toggleDetailsArea() {
		...
		if ( detailsArea == null ) {
			...
			detailsButton.setText("hideDetails");
		}
		...
		// Hide the details area.
			...
			detailsArea.dispose();
			detailsArea = null;
			detailsButton.setText("showDetails");
		}
