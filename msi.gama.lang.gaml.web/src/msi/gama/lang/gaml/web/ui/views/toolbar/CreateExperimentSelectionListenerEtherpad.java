 ...
 *
 */
public class CreateExperimentSelectionListenerEtherpad implements SelectionListener {

	EtherpadEditor editor;
	Control control;

	/**
	 * 
	 */
	public CreateExperimentSelectionListenerEtherpad(final EtherpadEditor editor, final Control toolbar) {
		this.editor = editor;
