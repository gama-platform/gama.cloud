...
public class GamlLabelProvider implements IGamlLabelProvider { //extends DefaultEObjectLabelProvider 
...
//			if (GamlOutlineTreeProvider.isAction((Statement) ele)) { return actionText((Statement) ele); }
	...
	public String getText(final ISyntacticElement element) {
		return this.getText((ISyntacticElement) element.getElement());
	}
	...
	public Object getImage(final ISyntacticElement element) {
		return this.getImage((ISyntacticElement) element.getElement());
	}
