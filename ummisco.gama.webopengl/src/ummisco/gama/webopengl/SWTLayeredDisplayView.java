/*********************************************************************************************
 *
 * 'SWTLayeredDisplayView.java, in plugin ummisco.gama.webopengl, is part of the source code of the GAMA modeling and
...
public class SWTLayeredDisplayView extends LayeredDisplayView {
	...
	public void waitToBeRealized() {
		...
		final String uid=RWT.getUISession().getAttribute("user").toString();
		WorkbenchHelper.asyncRun(uid,() -> WorkbenchHelper.getPage(uid).bringToTop(SWTLayeredDisplayView.this));
	}
