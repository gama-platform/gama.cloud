/*********************************************************************************************
 *
 * 'ModernRenderer.java, in plugin ummisco.gama.webopengl, is part of the source code of the GAMA modeling and simulation
...
public class ModernRenderer extends Abstract3DRenderer {
	...
	public void display(final GLAutoDrawable drawable) {
		...
		if (!visible) {
			...
			visible = true;
			final String uid=RWT.getUISession().getAttribute("user").toString();
			WorkbenchHelper.run(uid,() -> getCanvas().setVisible(true));
