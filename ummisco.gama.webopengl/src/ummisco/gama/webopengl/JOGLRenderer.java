/*********************************************************************************************
 *
 * 'JOGLRenderer.java, in plugin ummisco.gama.webopengl, is part of the source code of the GAMA modeling and simulation
...
import ummisco.gama.webopengl.scene.FieldDrawer;
import ummisco.gama.webopengl.scene.GeometryDrawer;
import ummisco.gama.webopengl.scene.ModelScene;
import ummisco.gama.webopengl.scene.ObjectDrawer;
import ummisco.gama.webopengl.scene.ResourceObject;
import ummisco.gama.webopengl.scene.StringDrawer;
...
public class JOGLRenderer extends Abstract3DRenderer {
	...
	public void display(final GLAutoDrawable drawable) {
		...
		if (!visible) {
			...
			final String uid=RWT.getUISession().getAttribute("user").toString();
			WorkbenchHelper.asyncRun(uid, () -> getCanvas().setVisible(true));
